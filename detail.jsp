...
<link rel="stylesheet"
	href="<%= request.getContextPath()+"/style3.css" %>">
...
<div id="blocdetail">
	<div class="card mb-3 blocdetail">
		<div class="card-body blocdes">
			...
			<p class="card-text">
				<span style="background: grey; color: white;">Prix:
					${monture_actuel.prix} euros</span>
			</p>
		...
		<form method="post" action="<%=request.getContextPath()%>/panier">
			<input name="reference" type="hidden"
				value="${monture_actuel.reference}"> <input name="quantite"
				type="hidden" value="1">
			<button type="submit" class="btn btn m-3 " id="ajouter">Ajouter
				au panier</button>
